...
function Titok({ ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
function Xiaohongshu({ ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
function Bell({ class: className, ...props }: IconProps) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      ...
      class={cn("lucide lucide-bell-icon lucide-bell", className)}
    >
...
function Moon(props: IconProps) {
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      class={cn("lucide lucide-moon-icon lucide-moon", props.class)}
    >
...
function Palette(props: IconProps) {
  return (
    <svg
      ...
      stroke-linejoin="round"
      {...props}
      class={cn("lucide lucide-palette-icon lucide-palette", props.class)}
    >
...
function Settings(props: IconProps) {
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      class={cn("lucide lucide-settings-icon lucide-settings", props.class)}
    >
...
function SquareSquare(props: IconProps) {
  return (
    <svg
      ...
      {...props}
      class={cn(
        "lucide lucide-square-square-icon lucide-square-square",
        props.class,
      )}
    >
...
function Sun(props: IconProps) {
  return (
    <svg
      ...
      {...props}
      stroke-linejoin="round"
      class={cn("lucide lucide-sun-icon lucide-sun", props.class)}
    >
...
function Box(props: IconProps) {
  return (
    <svg
      ...
      stroke-linejoin="round"
      {...props}
      class={cn("lucide lucide-box-icon lucide-box", props.class)}
    >
...
function Google(props: IconProps) {
  return (
    <svg
      ...
      {...props}
      class={cn(
        "lucide lucide-rectangle-goggles-icon lucide-rectangle-goggles",
        props.class,
      )}
    >
...
function Github(props: IconProps) {
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      class={cn("lucide lucide-github-icon lucide-github", props.class)}
    >
...
function MoveDown(props: IconProps) {
  return (
    <svg
      ...
      stroke-linejoin="round"
      {...props}
      class={cn("lucide lucide-move-down-icon lucide-move-down", props.class)}
    >
...
function MoveUp(props: IconProps) {
  return (
    <svg
      ...
      stroke-linejoin="round"
      {...props}
      class={cn("lucide lucide-move-up-icon lucide-move-up", props.class)}
    >
...
function Search(props: IconProps) {
  return (
    <svg
      ...
      stroke-linejoin="round"
      {...props}
      class={cn("lucide lucide-search-icon lucide-search", props.class)}
    >
...
function RefreshCcw(props: IconProps) {
  return (
    <svg
      ...
      {...props}
      class={cn(
        "lucide lucide-refresh-ccw-icon lucide-refresh-ccw",
        props.class,
      )}
    >
...
function ArrowUpDown(props: IconProps) {
  return (
    <svg
      ...
      {...props}
      class={cn(
        "lucide lucide-arrow-up-down-icon lucide-arrow-up-down",
        props.class,
      )}
    >
...
function X(props: IconProps) {
  return (
    <svg
      ...
      stroke-linejoin="round"
      {...props}
      class={cn("lucide lucide-x-icon lucide-x", props.class)}
    >
      <path d="M18 6 6 18" />
      <path d="m6 6 12 12" />
    </svg>
...
function Boxes(props: IconProps) {
  return (
    <svg
      ...
      stroke-linejoin="round"
      {...props}
      class={cn("lucide lucide-boxes-icon lucide-boxes")}
    >
